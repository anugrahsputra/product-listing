...
curl -s -X POST "$BASE_URL/products/" -H "Content-Type: application/json" -d "{\"name\": \"Img Test Prod $TS\", \"slug\": \"img-prod-$TS\", \"Description\": \"test\", \"category_ids\": [\"$CAT_ID\"], \"price\": 1.0}" > /dev/null
